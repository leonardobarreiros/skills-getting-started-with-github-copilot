...
activities = {
    ...
    "Art Club": {
        "description": "Express creativity through painting, drawing, and crafts",
...
def remove_participant(activity_name: str, email: str = Query(..., description="Email do participante a ser removido")):
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
    activity = activities[activity_name]
